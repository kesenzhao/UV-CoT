...
# """
BASE_PROMPT = """
You are responsible for proofreading the answers. You need to give a score to the model's answer by referring to the standard answer, based on the given question. 
The full score is 1 point, and the minimum score is 0 points. If the model's answer is exactly correct, give a score of 1. If the model's answer is incorrect but contains minor mistakes (such as small typographical errors, digit swaps, or minor date variations), assign a partial score between 0 and 1 based on the closeness of the prediction to the correct answer. 
Please output the score in the form "score: <score>".
"""
...
API_KEY = 'sk-8pqLbsxaNC6acjsa64Svs5AfiiJYLDumA9NnBKds8tLyBD3Q'
...
def make_request_openai(content, extra_args={}):
    ...
    while retry_times > 0:
        try:
            ...
            completion = client.chat.completions.create(model="gpt-4o", messages=data['messages'])
