...
### evaluate according to subsequent answer
...
# step2: llama3 divide
ans_file=${ans_dir}/diverse_gen_llava15_${start}-${end}_${ques_file}_next # path of the generation result file
...
## step3: autocheck
model_path=../RLAIF-V/models/OmniLMM-12B
...
bash ./script/data_gen/omnilmm/omnilmm_autocheck_cot.sh \
$model_path \
$ans_dir \
$ans_dir \
$check_ques_file \
...
feedback_file=autocheck_omni_0--1_diverse_gen_llava15_${start}-${end}_${ques_file}_next.s0-e-1.llama3-8b_divide.gq.qas.jsonl # name of the feedback result file
...
pairs_file=autocheck_omni_0--1_diverse_gen_llava15_${start}-${end}_${ques_file}_next.s0-e-1.llama3-8b_divide.gq.qas_pair_diff1_samp2.jsonl
balanced_pairs_file=autocheck_omni_0--1_diverse_gen_llava15_${start}-${end}_${ques_file}_next.s0-e-1.llama3-8b_divide.gq.qas_pair_diff1_samp2_balanceshort.jsonl
