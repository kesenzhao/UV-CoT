...
check_ques_file=diverse_gen_llava15_${start}-${end}_${ques_file}_next.jsonl # name of the divide-and-conquer result file

bash ./script/data_gen/omnilmm/omnilmm_directcheck.sh \
$model_path \
$ans_dir \
$ans_dir \
$check_ques_file \
...
# gq_file=diverse_gen_llava15_${start}-${end}_${ques_file}_next.jsonl # name of the divided answer file
# feedback_file=autocheck_omni_0--1_diverse_gen_llava15_${start}-${end}_${ques_file}_next.jsonl # name of the feedback result file
